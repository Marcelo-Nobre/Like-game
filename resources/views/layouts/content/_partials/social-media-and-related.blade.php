...
<li class="w-full md:block md:w-auto" id="navbar-social-media-1">
    <ul
        class="flex flex-row justify-between font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-800 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white bg-gray-800 md:bg-gray-900 border-gray-700">
        @foreach ([
                [
